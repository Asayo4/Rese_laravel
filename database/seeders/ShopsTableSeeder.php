...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $param = [
            ...
            'area_id' => 14,
            'genre_id' => 24,
            'detail' => 'イタリア製ピザ窯芳ばしく焼き上げた極薄のミラノピッツァや厳選されたワインをお楽しみいただけます。女子会や男子会、記念日やお誕生日会にもオススメです。', 'path' => '../assets/itarian.jpg'
        ];
        Shop::insert($param);
